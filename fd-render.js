...
function obterImagemFD(dados) {
  ...
  const imgMap = {
    'SW4': 'assets/fd/sw4.png',   'SW41': 'assets/fd/sw4.png',
    'SW3': 'assets/fd/sw4.png',
    'SV1': 'assets/fd/sv1.png',   'SV3': 'assets/fd/sv1.png',
    'DA3': 'assets/fd/da3.png',   'DA4': 'assets/fd/da3.png',
    'BLV1': 'assets/fd/blv1.png',
    'VPN': 'assets/fd/vpn.png',
    'D3': 'assets/fd/d3.png',     'D4': 'assets/fd/d3.png',
  };

  if (imgMap[modelo]) return imgMap[modelo];
  for (const [key, path] of Object.entries(imgMap)) {
    if (modelo.startsWith(key)) return path;
  }
